...
const char srv_key_rsa[] =
	...
	"MHcCAQEEILW6zjiSJdFbRNvASZ+UGp6Y7EE/NvWUNeIfrt8f/DX9oAoGCCqGSM49\r\n"
	"AwEHoUQDQgAEMQGxBKIZVO56Mcjzbaks5GkFhxnAh7fEL+CIcHcNPo6/sC90wwVV\r\n"
	"vjka9JPk2/WEm7tXaXBAWghWXRP++bgtfw==\r\n"
	"-----END EC PRIVATE KEY-----\r\n";
